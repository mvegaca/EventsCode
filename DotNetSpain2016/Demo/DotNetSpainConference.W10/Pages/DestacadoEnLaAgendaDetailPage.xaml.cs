//---------------------------------------------------------------------------
//
// <copyright file="DestacadoEnLaAgendaDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DestacadoEnLaAgendaDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DestacadoEnLaAgendaDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<DestacadoEnLaAgendaConfig>.Instance);
